...
class Image extends Component {
    static getDefaultImagePath() {
        return '/pf/resources/images/default_feed_image.jpg';
    }

    static addDefaultSrc(elm) {
        elm.target.src = Image.getDefaultImagePath(); // eslint-disable-line no-param-reassign
    }
    ...
    render() {
        ...
        return (
            <Static id={url}>
                <img
                    className="lazy"
                    onError={Image.addDefaultSrc}
                    src={Image.addDefaultSrc}
