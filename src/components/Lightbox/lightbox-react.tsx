...
import { ChevronRightIcon, ChevronLeftIcon, ZoomInIcon, ZoomOutIcon, CloseIcon } from "../icons";
			...
			>
				...
				>
					...
					{(this.props.imageCaption || this.props.children) && this.props.showImageCaption && (
						...
						>
							<div className="captionContent">{this.props.children || this.props.imageCaption}</div>
						</LightboxCaption>
					)}
				</LightboxContainer>
			</Modal>
