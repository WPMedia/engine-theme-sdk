...
describe("the CloseIcon component", () => {
	it("should render an SVG", () => {
		...
		expect(wrapper.prop("viewBox")).toEqual("0 0 352 512");
		expect(wrapper.prop("role")).not.toBeDefined();
	});

	it('should render as an "img" SVG', () => {
		const wrapper = shallow(<CloseIcon context="image" />);
		expect(wrapper.name()).toEqual("svg");
	...
	describe("the title prop", () => {
		it("should set the title of the svg element", () => {
			const wrapper = shallow(<CloseIcon title="an icon!" context="image" />);
	...
	describe("the description prop", () => {
		it("should set the description of the svg element", () => {
			const wrapper = shallow(<CloseIcon description="this is an icon!" context="image" />);
