...
const CameraIcon: FC<IconProps> = ({
  width = 24, height = 24, fill = '#000', title = 'Camera', description = '', context = 'presentational',
}) => (
  <svg width={width} height={height} xmlns="http://www.w3.org/2000/svg" viewBox="0 -256 1950 1950" {...additionalSVGProps(context)}>
    {context === 'image'
      ? (
        <>
          <title>{title}</title>
