...
describe('the ArrowLeftIcon component', () => {
  ...
  it('should render as an "img" SVG', () => {
    const wrapper = shallow(<ArrowLeftIcon context="image" />);
    expect(wrapper.name()).toEqual('svg');
    expect(wrapper.prop('viewBox')).toEqual('0 0 448 512');
  ...
  describe('the title prop', () => {
    it('should set the title of the svg element', () => {
      const wrapper = shallow(<ArrowLeftIcon title="an icon!" context="image" />);
  ...
  describe('the description prop', () => {
    it('should set the description of the svg element', () => {
      const wrapper = shallow(<ArrowLeftIcon description="this is an icon!" context="image" />);
