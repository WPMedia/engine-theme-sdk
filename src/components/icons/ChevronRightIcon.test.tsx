...
describe('the ChevronRightIcon component', () => {
  ...
  it('should render as an "img" SVG', () => {
    const wrapper = shallow(<ChevronRightIcon context="image" />);
    expect(wrapper.name()).toEqual('svg');
  ...
  describe('the title prop', () => {
    it('should set the title of the svg element', () => {
      const wrapper = shallow(<ChevronRightIcon title="an icon!" context="image" />);
  ...
  describe('the description prop', () => {
    it('should set the description of the svg element', () => {
      const wrapper = shallow(<ChevronRightIcon description="this is an icon!" context="image" />);
