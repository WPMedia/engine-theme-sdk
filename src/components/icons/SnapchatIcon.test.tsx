...
describe("the SnapchatIcon component", () => {
	...
	it('should render as an "img" SVG', () => {
		const wrapper = shallow(<SnapchatIcon context="image" />);
		expect(wrapper.name()).toEqual("svg");
	...
	describe("the width prop", () => {
		it("should set the width of the svg element", () => {
			const wrapper = shallow(<SnapchatIcon width={42} />);
	...
	describe("the height prop", () => {
		it("should set the height of the svg element", () => {
			const wrapper = shallow(<SnapchatIcon height={42} />);
	...
	describe("the fill prop", () => {
		it("should set the fill color of the svg element", () => {
			const wrapper = shallow(<SnapchatIcon fill="#222222" />);
	...
	describe("the title prop", () => {
		it("should set the title of the svg element", () => {
			const wrapper = shallow(<SnapchatIcon title="an icon!" context="image" />);
			expect(wrapper.find("title").text()).toEqual("an icon!");
		});

		it("should default to an empty string", () => {
			const wrapper = shallow(<SnapchatIcon context="image" />);
			expect(wrapper.find("title").text()).toEqual("Snapchat logo");
		});
	});

	describe("the description prop", () => {
		it("should set the description of the svg element", () => {
			const wrapper = shallow(<SnapchatIcon description="this is an icon!" context="image" />);
