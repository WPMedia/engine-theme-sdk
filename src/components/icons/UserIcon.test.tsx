...
describe('the UserIcon component', () => {
  ...
  it('should render as an "img" SVG', () => {
    const wrapper = shallow(<UserIcon context="image" />);
    expect(wrapper.name()).toEqual('svg');
  ...
  describe('the title prop', () => {
    it('should set the title of the svg element', () => {
      const wrapper = shallow(<UserIcon title="an icon!" context="image" />);
  ...
  describe('the description prop', () => {
    it('should set the description of the svg element', () => {
      const wrapper = shallow(<UserIcon description="this is an icon!" context="image" />);
