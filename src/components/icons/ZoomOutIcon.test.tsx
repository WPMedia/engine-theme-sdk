...
describe("the ZoomOutIcon component", () => {
	...
	it('should render as an "img" SVG', () => {
		const wrapper = shallow(<ZoomOutIcon context="image" />);
		expect(wrapper.name()).toEqual("svg");
	...
	describe("the title prop", () => {
		it("should set the title of the svg element", () => {
			const wrapper = shallow(<ZoomOutIcon title="an icon!" context="image" />);
	...
	describe("the description prop", () => {
		it("should set the description of the svg element", () => {
			const wrapper = shallow(<ZoomOutIcon description="this is an icon!" context="image" />);
