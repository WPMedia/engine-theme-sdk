...
describe('the ShareIcon component', () => {
  ...
  it('should render as an "img" SVG', () => {
    const wrapper = shallow(<ShareIcon context="image" />);
    expect(wrapper.name()).toEqual('svg');
  ...
  describe('the title prop', () => {
    it('should set the title of the svg element', () => {
      const wrapper = shallow(<ShareIcon title="an icon!" context="image" />);
  ...
  describe('the description prop', () => {
    it('should set the description of the svg element', () => {
      const wrapper = shallow(<ShareIcon description="this is an icon!" context="image" />);
