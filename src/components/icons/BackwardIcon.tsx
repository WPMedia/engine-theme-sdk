...
const BackwardIcon: FC<IconProps> = ({
  width = 24, height = 24, fill = '#000', title = 'Backward', description = '', context = 'presentational',
}) => (
