...
To test this locally, add a `blocks.json` to the `src` folder. You'll already notice that this is ignored by git in the `.gitignore` . You can find a valid blocks.json here: https://github.com/WPMedia/Fusion-News-Theme/blob/master/blocks.json
...
For other available language mappings, what's inputted will be what's outputted: 
